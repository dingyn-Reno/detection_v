...
path = '/ssd2/dingyuning/internvl/evals/InternVL/'
...
with open('evals/origin_res_54/coco_instances_results.json','r') as f:
    results = json.load(f)

label_json_path = 'evals/jsons/chengguan_20240412_58cls_add_xiaoguanggao_test.json'
...
base_path = '/ssd3/vis_data/ai-city-manage/13cls_weizhang_det/'
debug=False
new_results=[]
print(len(results))
score_thrs=0.1
...
with open('evals/new_res_54/coco_instances_results.json','w') as f:
